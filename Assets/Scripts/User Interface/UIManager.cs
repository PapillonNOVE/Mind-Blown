...
public class UIManager : Singleton<UIManager>
{
	...
	public void ShowAprrovePendingQuestionsPanel() { PanelChanger(Panels.AprrovePendingQuestions); }
	...
	private void PanelChanger(Panels panels)
	{
		...
		pnl_SendQuestion.SetActive(panels == Panels.SendQuestion);
		pnl_ApprovePendingQuestions.SetActive(panels == Panels.AprrovePendingQuestions);
